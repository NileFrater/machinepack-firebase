module.exports = {
  ...
  friendlyName: 'Query by Child_Removed',

  description: 'Read data from all child nodes, triggered whenever a child node is removed, from a specific firebase location, such as "/users/".',
