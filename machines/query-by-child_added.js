module.exports = {
  ...
  friendlyName: 'Query by Child_Added',

  description: 'Read data from all child nodes, triggered whenever a new child is added, from a specific firebase location, such as "/users/".',
